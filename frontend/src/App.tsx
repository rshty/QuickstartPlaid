    ...
    <div className={styles.App}>
      <div className={styles.container}>
        ...
        {linkSuccess && (
          ...
          <button onClick={acquireTransactions}> Get Transactions Now! </button>
          <button onClick={acquireBalance}> Get Balance Now! </button>
          </>
        )}
      </div>
    </div>
...
const acquireTransactions = async () => {
